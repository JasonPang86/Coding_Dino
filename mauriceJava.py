...
player = Dino(440, 450, 4, 'Assets\mort.png', 8, 'player')
Maurice = Dino(600, 450, 4, 'Assets\Berry.png', 3, 'Berry')
Berry = Dino(2800, 400, 8, 'Assets\Berry.png', 3, 'Berry')
Gary = Dino(1000, 425, 6, 'Assets\Gary.png', 3, 'Berry')
KingJulian = Dino(2000,425,6, 'Assets\Larry.png',3,'Berry')
x = 0
